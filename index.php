          ...
          <div class="col item-title">
            <div class="card text-center">
              <div class="card-body list-tilte">
                <img class="img-list" src="assets/images/favicons/android-chrome-512x512.png" alt="">
                <a href="#document">
          ...
          <div class="col item-title">
            <div class="card text-center">
              <div class="card-body list-tilte">
                <img class="img-list" " src=" assets/images/favicons/android-chrome-512x512.png" alt="">
                <a href="">
                  <a href="https://www.artsteps.com/view/6271d0df21f9afa6c9884dcf/?currentUser">
              ...
              echo '
                <div class="col-xl-3 col-lg-6 col-md-6">
                  <div class="courses-one__single wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1000ms">
                    ...
                    <img style="width: 100%;" src="assets/images/feauters/logo png word.png" alt="">
                    ...
                    <div class="courses-one__single-content">
                      ...
                      <h4 class="courses-one__single-content-title title-document">
                        ' . $row['name'] . '
                      </h4>
                      <div class="courses-one__single-content-review-box flex">
                        <a class="overlay-text btn-download" href="' . $url  . $row['path_file'] . '">Tải xuống</a>
                       
                      </div>
                      <div class="courses-one__single-content-review-box flex">
                      <a class="overlay-text btn-download" target="_blank" rel="noopener noreferrer" href="' . $row['url'] . '">Xem trực tiếp</a>
