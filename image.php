...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="container">
            <h1 class="m-4" style="text-align: center; text-transform: uppercase;">Tranh cổ động đại hội</h1>
            <div class="row justify-content-md-center">
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo '<div class="col-md-auto image-library mt-4 mb-3">
                        <img src="' . $url . $row['path_file'] . '" alt="" />
                    </div>';
                    }
                }
                ?>
