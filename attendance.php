...
<head>
    ...
    <script src="assets/js/vitri.js"></script>
...
<body>
    ...
    <div class="page-wrapper">
                    ...
                    <div class="main-header--one__top-inner clearfix">
                        <div class="main-header--one__top-left">
                            <div class="main-header--one__top-logo">
                                <a href="index.html"><img src="assets/images/resources/logo-1.png" alt="" class="logo" /></a>
                            </div>
                        </div>
                            ...
                            <div class="main-header--one__top-contact-info clearfix">
                                <ul class="main-header--one__top-contact-info-list list-unstyled">
                                    <li class="main-header--one__top-contact-info-list-item">
                                        ...
                                        <div class="text">
                                            <h6>Call Agent</h6>
                                            <p><a href="tel:123456789">0961463407</a></p>
                                        </div>
                                    </li>
                                    <li class="main-header--one__top-contact-info-list-item">
                                        <div class="icon">
                                        ...
                                        <div class="text">
                                            <h6>Call Agent</h6>
                                            <p><a href="mailto:info@templatepath.com">duchai2712@gmail.com</a></p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <div class="main-menu__right">
                                        <div class="main-menu__right-cart-search">
                                            <div class="main-menu__right-search-box">
                                                <a href="#" class="thm-btn search-toggler">Tìm kiếm</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="attendance">
            <h4 class="section-title__title" id="title">Số ghế của bạn</h4>
            <hr>
            ...
            <a class='thm-btn reset' id='khoi' onclick="reset()">Chọn lại</a>
        </div>

        <div class="sodo" id="sodo">
            <h3>Sơ đồ</h3>
            <hr>

            <table class="status">
                <tr>
                    <td class="checkIn"> Đã điểm danh </td>
                    <td class="noCheckIn"> Chưa điểm danh </td>
                    <td class="none"> Ghế trống </td>
                </tr>
            </table>
